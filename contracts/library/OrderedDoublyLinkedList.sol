...
contract OrderedDoublyLinkedList is IDoublyLinkedList {
    ...
    function insert(uint256 id, uint256 value, uint256 nearestSpot) external override {}

    function update(uint256 id, uint256 value, uint256 nearestSpot) external override {}
